...
#define MESSAGELENGTH 64       // Total message buffer length for transmission
...
void transmitMessageChunks(const String& message) {
  ...
  for (int chunkIndex = 0; chunkIndex < totalChunks; chunkIndex++) {
    ...
    snprintf((char*)buf, MESSAGELENGTH, "%5d %5d %5d %5d %5d %5d %s", SEQ, TYPE, TAGID, RELAYID, TTL, thisRSSI, hexCiphertext);
